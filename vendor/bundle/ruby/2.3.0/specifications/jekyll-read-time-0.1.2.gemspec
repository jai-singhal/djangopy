...
Gem::Specification.new do |s|
  ...
  s.date = "2018-01-29"
  s.description = "Jekyll liquid tag to indicating the read time of the content"
  s.email = ["jam@jamrizzi.com"]
  s.homepage = "https://github.com/jamrizzi/jekyll-read-time"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.5.2.1"
  s.summary = "Jekyll liquid tag to indicating the read time of the content"
